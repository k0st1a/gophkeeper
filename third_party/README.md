...
Swagger-compliant API definition in [auth.swagger.json](./OpenAPI/auth.swagger.json)
file. That file is auto-generated by running `make swagger-ui-generate` in the root
